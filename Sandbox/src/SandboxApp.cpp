...
public:
		...
		: Layer("Example"), m_Camera(-1.6f, 1.6f, -0.9f, 0.9f), m_CameraPosition(0.0f)
	{
		...
		m_FlatColorShader = Hazel::Shader::Create("FlatColor", blueShaderVertexSrc, flatColorShaderFragmentSrc);

		auto textureShader = m_ShaderLibrary.Load("assets/shaders/Texture.glsl");

		m_Texture = Hazel::Texture2D::Create("assets/textures/Checkerboard.png");
		m_FountainTexture = Hazel::Texture2D::Create("assets/textures/Fountain.png");
...
private:
	...
	Hazel::Ref<Hazel::Texture2D> m_Texture, m_FountainTexture;
