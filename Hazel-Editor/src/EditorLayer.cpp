...
namespace Hazel
{
	...
	void EditorLayer::OnAttach()
	{
		...
		m_TextureGrass = SubTexture2D::CreateFromCoords(m_SpriteSheet, { 1, 11 }, { 128, 128 });
	...
	void EditorLayer::OnUpdate(Timestep ts)
	{
		...
		
		{
			...
			Renderer2D::DrawRotatedQuad({ -0.5f, -0.5f }, { 1.0f, 1.0f }, glm::radians(rotation), m_CheckerBoardTexture, 20.0f, { 0.8f, 0.8f, 1.0f, 1.0f });
			Renderer2D::EndScene();
