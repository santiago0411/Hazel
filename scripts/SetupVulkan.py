...
class VulkanConfiguration:
    ...
    def Validate(cls):
        ...
        if (not cls.CheckVulkanSDKDebugLibs()):
            print(f"\nNo Vulkan SDK debug libs found. Debug configuration will not be available. Make sure to also select 'Debuggable Shader API Libraries - 64 bit' when installing Vulkan if you wish to run Hazel in Debug configuration.")
